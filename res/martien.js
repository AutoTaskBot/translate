const infos = { premium: 'Pour plus d\'informations sur AutoTask, jeune Terrien, utilisez la commande `/premium`.' };
module.exports = {
    interactionCreate: {
        error: 'Terrien, lors de l\'exécution de la commande, Tomas pesquet a brouillé les données en alumant une enceinte...\nCode d\'erreur:',
        reported: 'Le problème a été signalé, mais on peut avoir besoin de ton aide pour résoudre le problème, jeune Terrien.',
        join_support: 'Se rendre sur le serveur support'
    },
    autotask: {
        only_web: 'Désolé ! La fonction d\'AutoTask est uniquement disponible dans votre navigateur (c\'est plus beau et mieux compréhensible).\nVous pouvez aller configurer AutoTask juste ici : **https://www.zygocraft.com/autotask**',
        list: {
            notask: [
                'Il n\'y a aucune AutoTask sur votre serveur',
                'avec le paramètre definis',
                '...'
            ],
            no_action: 'Aucune action',
            all_events: 'Tous les évenements définis sur le serveur :'
        }
    },
    giveaway: {
        end_: {
